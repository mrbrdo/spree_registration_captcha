...
require 'spree_registration_captcha/version'

Gem::Specification.new do |s|
  s.platform    = Gem::Platform::RUBY
  s.name        = 'spree_registration_captcha'
  s.version     = SpreeRegistrationCaptcha::VERSION
  s.summary     = 'SpreeRegistrationCaptcha'
